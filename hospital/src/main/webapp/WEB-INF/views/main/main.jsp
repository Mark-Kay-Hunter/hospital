...
<style>
	...
	#letter { font-family: 'Jeju Gothic', serif; font-size:15px; }
...
<button type=button id=news2 onclick='open_in_main("/hospital/main/news2")'>피부과 개원</button> <br>
<button type=button id=news3 onclick='open_in_main("/hospital/main/news3")'>가톨릭대학교 성모병원 진료협약 체결</button> <br>
<button type=button id=news4 onclick='open_in_main("/hospital/main/news4")'>병원 새소식을 알려드립니다!</button> <br>
</div>
