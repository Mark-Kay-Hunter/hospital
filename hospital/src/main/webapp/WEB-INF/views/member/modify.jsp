...
<script>
	...
	/*  미작성한 내용 있는지 체크, 비밀번호 일치 체크 알림 띄우기 */
...
<form name="member" action="modify" onsubmit="return rule_check(this)">
<!-- hidden 전부 여기에 몰빵 -->
...
<table width="590" cellspacing="0" cellpadding="3" align="center" border="0" style="font-family:돋움,Dotum,sans-serif;">
    ...
    <tr>
        ...
        <td bgcolor="#FFFFFF" width="480"><input type="text" name="idno" id="idno" value="${idno}" style="border:1px solid #DBDBDB;" maxlength="8" readonly> ID(회원번호)는 자동생성됩니다</td>
    </tr>
    <tr>
        <td height="1" colspan="2" bgcolor="#FF7A96"  width="584"></td>
    </tr>
        ...
        <td bgcolor="#FFFFFF" style="padding:0;" width="486">
            <table width="100%" cellpadding="0" cellspacing="0" style="font-family:돋움,Dotum,sans-serif;">
                <tr>
                    ...
                    <td width="389" colspan="2"><input type="text" name="name" value="${name}" style="border:1px solid #DBDBDB;"></td>
                </tr>
                <tr>
...
<input type="text" name="adr1" id="adr1" style="border:1px solid #DBDBDB;" placeholder="주소" readonly>
                ...
                <tr>
                    ...
                    <input type="text" name="ph" value="${ph}" style="border:1px solid #DBDBDB;" size="12"> ('-' 없이 입력해주세요.)
                    </td>
                </tr>
                <tr>
                    <td height="15" align="center" bgcolor="#FBF3F3" width="97">이메일</td>
                    <td height="30" colspan="2" bgcolor="#FBF3F3" width="389"><input type="text" name="em" value="${em}" style="border:1px solid #DBDBDB;"></td>
                </tr>
            </table>
        </td>
    </tr>
