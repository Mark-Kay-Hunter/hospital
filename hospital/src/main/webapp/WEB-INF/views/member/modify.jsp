...
<table width="590" cellspacing="0" cellpadding="3" align="center" border="0">
    ...
    <tr>
        <th height="30" colspan="2" bgcolor="#EEEEEE" style="color:#4989D2;" width="584"><font size=16px>회원정보수정</font></th>
    </tr>
    <tr>
        <td height="1" colspan="2" bgcolor="#FFFFFF" width="584"></td>
    </tr>
    ...
    <tr>
        ...
        <td bgcolor="#FFFFFF" width="480"><input type="text" name="idno" id="idno" style="border:1px solid #DBDBDB;" maxlength="8" readonly placeholder="93460001"> ID(회원번호)는 변경할 수 없습니다.</td>
    </tr>
    <tr>
        <td height="1" colspan="2" bgcolor="#7AACFF"  width="584"></td>
    </tr>
...
<input type="text" name="adr1" id="adr1" style="border:1px solid #DBDBDB;" placeholder="주소" readonly>
    ...
    <tr>
        <td colspan="2" align="center" height="40" width="584">
            <input type="submit" value="정보수정" style="font-size:12px; background-color:#EEEEEE; border:1px ridge #DBDBDB;">
            <input type="reset" value="취소" style="font-size:12px; background-color:#EEEEEE; border:1px ridge #DBDBDB;">
        </td>
    </tr>
</table>
